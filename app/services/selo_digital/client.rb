...
module SeloDigital
  class Client
    ...
    # valorFermoju, retificacao?, sqAto_idOriginal, parte_pessoa_dados (AtoPraticado
    ...
    # escritura ou testamento, stiposelagem "D"/"C"/"E"/"T"), caso em que o real
    # é usado em vez do placeholder. Ver CLAUDE.md antes de usar isso em produção.
    #
